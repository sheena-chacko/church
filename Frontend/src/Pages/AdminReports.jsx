...
const AdminReports = () => {
  ...
  const reports = [
    { id: 1, title: "Monthly Donations Report", date: "February 2025", details: "Total donations collected: $5,320" },
    { id: 2, title: "Expense Reports", date: "March 2025", details: "Total attendees: 240" },
    { id: 3, title: "Financial Reports", date: "January 2025", details: "Total participants: 85" },
    { id: 4, title: "Balance Sheet Report", date: "Year 2024", details: "Total Income: $50,000 | Expenses: $35,000 | Savings: $15,000" },
    { id: 5, title: "Income Reports", date: "March 2025", details: "Total attendees: 240" },
  ];

...
const VerifyUsers = () => {
  ...
  const {
    ...
    queryFn: userService.getVerifiedUsers, // You should create this function in your service
  });
  ...
  if (isUnverifiedLoading || isVerifiedLoading) {
    return <p className="text-center text-gray-600">Loading users...</p>;
  }

  if (isUnverifiedError || isVerifiedError) {
    return (
      <p className="text-red-600 text-center">
        {unverifiedError?.message || verifiedError?.message || "Failed to load users."}
      </p>
    );
  }
